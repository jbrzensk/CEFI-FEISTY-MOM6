...
#INCLUDES = -I/usr/include/mpich-x86_64/ -I/usr/lib64/gfortran/modules/mpich/ -I/usr/lib64/mpich/lib/ -I/usr/lib64/gfortran/modules/mpich/ -I/usr/lib64/mpich/lib/
INCLUDES = 
...
# -flto is final optomization
FFLAGS_OPT = -Ofast -march=znver3
FFLAGS_REPRO = -O2 -fbounds-check
FFLAGS_DEBUG = -Og -g -W -fbounds-check -fbacktrace #-fdump-tree-all-graph #-ffpe-trap=invalid,zero,overflow
# add -pg for profiling information
...
# Flags based on perforance target (production (OPT), reproduction (REPRO), or debug (DEBUG)
# -flto is final optomization
CFLAGS_OPT = -Ofast -march=znver3
CFLAGS_REPRO = -O2
CFLAGS_DEBUG = -Og -g #-fdump-tree-all-graph
# add -pg for profiling information
#
# Flags to add additional build options
...
# Linking flags
#LDFLAGS := -L/opt/sw/spack/linux-ubuntu22.04-zen4/gcc-11.4.0/netcdf-c-4.9.2-75pgbfk26iyvayc7onnbuylyd4rlscel/lib -lnetcdf
